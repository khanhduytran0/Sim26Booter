// https://github.com/facebook/idb/blob/main/PrivateHeaders/SimulatorApp/Indigo.h
...
typedef mach_msg_header_t MachMessageHeader;
 ...
 */
typedef struct {
  unsigned int index; // 0x20 + 0x10 + 0x0 = 0x30
  unsigned int identity; // 0x20 + 0x10 + 0x4 = 0x34
  unsigned int eventMask; // 0x20 + 0x10 + 0x8 = 0x38
  double xRatio; // 0x20 + 0x10 + 0xc = 0x3c
  double yRatio; // 0x20 + 0x10 + 0x14 = 0x44
  double zRatio; // 0x20 + 0x10 + 0x1c = 0x4c
  double tipPressure; // 0x20 + 0x10 + 0x24 = 0x54
  double twist; // 0x20 + 0x10 + 0x2c = 0x5c
  unsigned int inRange; // 0x20 + 0x10 + 0x34 = 0x64
  unsigned int touch; // 0x20 + 0x10 + 0x38 = 0x68
  unsigned int options; // 0x20 + 0x10 + 0x3c = 0x6c
...
/*
 ...
 could you write a structure out of these info:
 ```
 ...
 IOHIDEventCreateDigitizerFingerEvent( kCFAllocatorDefault, *(_QWORD *)(a1 + 4), *(unsigned int *)(a1 + 16), *(unsigned int *)(a1 + 20), *(unsigned int *)(a1 + 24), *(unsigned int *)(a1 + 68), *(unsigned int *)(a1 + 72), *(unsigned int *)(a1 + 12), *(double *)(a1 + 28), *(double *)(a1 + 36), *(double *)(a1 + 44), *(double *)(a1 + 52), *(double *)(a1 + 60));
 ```
 */
